...
import { BookOpen, BookText, BookMarked, Star, Calendar, User, Tag, ArrowLeft, Edit, Share, Check } from "lucide-react"
        ...
        <div className="md:col-span-1">
          <div className="sticky top-20 space-y-4">
              ...
              <div className="flex">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    className={`h-5 w-5 ${
                      i < book.rating ? "text-yellow-500 fill-yellow-500" : "text-muted-foreground"
                    }`}
                  />
                ))}
              </div>
            ...
            <Card>
              ...
              <CardContent>
                <RadioGroup value={bookStatus} onValueChange={handleStatusChange} className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="want-to-read" id="want-to-read" />
                    <Label htmlFor="want-to-read" className="flex items-center gap-2 cursor-pointer">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="reading" className="flex items-center gap-2 cursor-pointer">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="read" className="flex items-center gap-2 cursor-pointer">
